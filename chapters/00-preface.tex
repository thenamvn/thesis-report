...
\vspace{1cm}
\noindent\textbf{Keywords:} Gamification, E-Learning, Online-to-Offline (O2O), AI Content Generation, Online Proctoring, Anti-Cheating Systems, Microservices, Educational Technology, System Architecture, React.js, Node.js, User Engagement.
