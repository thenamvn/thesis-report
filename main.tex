...
\begin{document}
    ...
    \begin{titlepage}
        ...
        {\fontsize{18pt}{22pt}\selectfont \textbf{TEKUTOKO: A MICROSERVICE-BASED GAMIFIED E-LEARNING PLATFORM WITH AI-DRIVEN CONTENT GENERATION AND INTEGRATED PROCTORING}\par}
        ...
        % Footer
        {\fontsize{14pt}{17pt}\selectfont \textbf{Hanoi – 2025}\par}
    ...
    \begin{titlepage}
        ...
        % Supervisor Info
        {\fontsize{14pt}{17pt}\selectfont \textbf{Supervisor: Dr. Nguyen Van Tinh}\par}
